...
状态：**PHASE 3 DONE / FROZEN；PHASE 4 AI SHADOW DONE / FROZEN**。
...
Phase 3B 增加 Connector Migration、`migration_held` durable hold、Telegram pairing、Audit 和 Dashboard Migration Wizard；这些能力在 `phase3-baseline` 冻结。Phase 4 的 AI Provider、Shadow、Profile 和 Evaluation 只读取观察旁路，不改变本阶段的 Legacy 行为。详见 [P3B Connector Migration](./P3B_CONNECTOR_MIGRATION.md) 和 [Phase 4 — AI Shadow](../phase4/README.md)。
