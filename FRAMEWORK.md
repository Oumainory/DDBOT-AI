...
文档地址：
[![GoDoc](http://img.shields.io/badge/go-documentation-blue.svg?style=flat-square)](https://pkg.go.dev/github.com/Oumainory/DDBOT-AI)
...
DDBOT提供了一个插件脚手架，可以快速创建一个插件模版：[DDBOT-template](https://github.com/Oumainory/DDBOT-AI-template)

在编写插件前，请先阅读一个示例插件：[DDBOT-example](https://github.com/Oumainory/DDBOT-AI-example)
...
// 引入刚刚编写的插件
import (
    _ "github.com/Oumainory/DDBOT-AI-example/concern"
)
```
