...
状态：**P3A DONE / CLOSED；P3B READY；AI NOT STARTED**。
...
Phase 3A 不实现 Connector Migration、`migration_held` runtime、Telegram pairing、Normalizer、AI Provider、Shadow、Profile 或 ENFORCE。详见 [P3A Domain / Projection / Discovery](./P3A_DOMAIN_PROJECTION_DISCOVERY.md)。
