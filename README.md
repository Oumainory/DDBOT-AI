...
仓库已完成并冻结 Phase 0 / Phase 1 基础契约阶段，冻结点分别为 `phase0-baseline`（`2030834d423e8313df4ae7a937aec0f0badbd443`）和 `phase1-baseline`（`6b1d591f388f50a31855a8f93a50c4a344e2b01e`）。P2A Passive Observation Runtime 已完成；该旁路运行时只记录 Event、Route 和 Delivery 事实，不改变 Legacy WSa 行为：
...
- Phase 0 和 Phase 1 已标记为 `DONE / FROZEN`，P2A 已标记为 `DONE / CLOSED`；Phase 2 后续范围尚未开始。P2A 的旁路不变量见 [Phase 2 — Observation](./docs/phase2/README.md) 和 [P2A Passive Observation](./docs/phase2/P2A_PASSIVE_OBSERVATION.md)。
